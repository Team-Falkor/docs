...
- `url`: The URL of the game, or if multiple choice is set a base64 string which will be sent to the /return endpoint
- `size`: The size of the game in bytes.
- `mutiple_choice`: setting the value here will override the one set in the setup.json (optional)
